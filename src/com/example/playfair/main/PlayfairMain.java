...
public class PlayfairMain {
	...
	/**
	 * <p>
	 * Construct a table in String type which is corresponded to the key. Non alphabetic character can be ignore automatically
	 * 
	 * @param key
	 *            The target key used to encode/decode
	...
	/**
	 * Check whether to skip the current character. See I and J as equal
	 * 
	 * @param halfTable
	 *            The key from user define
	 * @param c
	 *            The current character that will be add
	...
	/**
	 * Extract the information hided in the target words, then turn into a special form for encryption. Non alphabetic character can be ignore
	 * automatically
	 * 
	 * @param words
	 *            The target words which contains information
	 * @return The info in a special form for encryption
	 */
	...
	/**
	 * Turn info into a ciphertext
	 * 
	 * @param info
	 *            The info in a special form
